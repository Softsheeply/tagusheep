    ...
    <main className="mx-auto max-w-md p-6 space-y-6">
      <div>
        ...
        <p className="mt-2 text-white/70">
          Sign in to upload tags, earn contributor badges, and help grow the archive.
        </p>
      </div>
            ...
            {EMAIL_AUTH_ENABLED && (
              <>
                ...
                <form onSubmit={handleSubmit} className="space-y-3">
                  ...
                  <button type="submit" disabled={busy} className="w-full rounded-xl border border-white/15 px-4 py-3 font-medium text-white transition hover:border-emerald-300/50 disabled:opacity-50">
